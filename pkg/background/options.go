...
func (b *Background) CheckOptionPriceInBG(author, ticker, contractType, day, month, year string, price float32, manageChan chan ManageMsg, priceChan chan<- chan float32, exitChan chan<- bool) {
